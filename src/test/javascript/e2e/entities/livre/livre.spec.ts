...
describe('Livre e2e test', () => {
  ...
  it('should load Livres', async () => {
    ...
    expect(await livreComponentsPage.getTitle()).to.eq('jhdemoApp.livre.home.title');
  ...
  it('should load create Livre page', async () => {
    ...
    expect(await livreUpdatePage.getPageTitle()).to.eq('jhdemoApp.livre.home.createOrEditLabel');
  ...
  it('should delete last Livre', async () => {
    ...
    expect(await livreDeleteDialog.getDialogTitle()).to.eq('jhdemoApp.livre.delete.question');
