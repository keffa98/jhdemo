...
describe('Auteur e2e test', () => {
  ...
  it('should load Auteurs', async () => {
    ...
    expect(await auteurComponentsPage.getTitle()).to.eq('jhdemoApp.auteur.home.title');
  ...
  it('should load create Auteur page', async () => {
    ...
    expect(await auteurUpdatePage.getPageTitle()).to.eq('jhdemoApp.auteur.home.createOrEditLabel');
  ...
  it('should create and save Auteurs', async () => {
    ...
    await promise.all([
      auteurUpdatePage.setAuteurInput('auteur'),
      // auteurUpdatePage.livreSelectLastOption(),
    ]);
  ...
  it('should delete last Auteur', async () => {
    ...
    expect(await auteurDeleteDialog.getDialogTitle()).to.eq('jhdemoApp.auteur.delete.question');
