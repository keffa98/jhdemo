...
describe('Exemplaire e2e test', () => {
  ...
  it('should load Exemplaires', async () => {
    ...
    expect(await exemplaireComponentsPage.getTitle()).to.eq('jhdemoApp.exemplaire.home.title');
  ...
  it('should load create Exemplaire page', async () => {
    ...
    expect(await exemplaireUpdatePage.getPageTitle()).to.eq('jhdemoApp.exemplaire.home.createOrEditLabel');
  ...
  it('should delete last Exemplaire', async () => {
    ...
    expect(await exemplaireDeleteDialog.getDialogTitle()).to.eq('jhdemoApp.exemplaire.delete.question');
