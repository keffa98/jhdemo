...
describe('Region e2e test', () => {
  ...
  it('should load Regions', async () => {
    ...
    expect(await regionComponentsPage.getTitle()).to.eq('jhdemoApp.region.home.title');
  ...
  it('should load create Region page', async () => {
    ...
    expect(await regionUpdatePage.getPageTitle()).to.eq('jhdemoApp.region.home.createOrEditLabel');
  ...
  it('should create and save Regions', async () => {
    ...
    await promise.all([regionUpdatePage.setCodePostalInput('5'), regionUpdatePage.setNameInput('name')]);

    expect(await regionUpdatePage.getCodePostalInput()).to.eq('5', 'Expected codePostal value to be equals to 5');
  ...
  it('should delete last Region', async () => {
    ...
    expect(await regionDeleteDialog.getDialogTitle()).to.eq('jhdemoApp.region.delete.question');
