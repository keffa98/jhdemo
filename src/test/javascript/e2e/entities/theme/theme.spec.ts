...
describe('Theme e2e test', () => {
  ...
  it('should load Themes', async () => {
    ...
    expect(await themeComponentsPage.getTitle()).to.eq('jhdemoApp.theme.home.title');
  ...
  it('should load create Theme page', async () => {
    ...
    expect(await themeUpdatePage.getPageTitle()).to.eq('jhdemoApp.theme.home.createOrEditLabel');
  ...
  it('should create and save Themes', async () => {
    ...
    await promise.all([
      themeUpdatePage.setThemeInput('theme'),
      // themeUpdatePage.livreSelectLastOption(),
    ]);
  ...
  it('should delete last Theme', async () => {
    ...
    expect(await themeDeleteDialog.getDialogTitle()).to.eq('jhdemoApp.theme.delete.question');
