...
import com.ynov.demo.domain.Region;
import com.ynov.demo.repository.RegionRepository;
import com.ynov.demo.service.RegionService;
...
public class RegionResourceIT {
    ...
    public void createRegion() throws Exception {
        ...
        assertThat(testRegion.getCodePostal()).isEqualTo(DEFAULT_CODE_POSTAL);
    ...
    public void updateRegion() throws Exception {
        ...
        Region testRegion = regionList.get(regionList.size() - 1);
        assertThat(testRegion.getCodePostal()).isEqualTo(UPDATED_CODE_POSTAL);
